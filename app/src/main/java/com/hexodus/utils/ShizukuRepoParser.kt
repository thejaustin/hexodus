...
object ShizukuRepoParser {
    ...
    data class ShizukuApp(
        ...
        /** Android package name — used for direct Play Store deep links when known. */
    ...
    private fun getFallbackList(): List<ShizukuApp> = listOf(
        ...
        ShizukuApp("KernelSU-Next", "2026 standard for stealth root — implements root directly in the Linux Kernel.", "rifsxd", "https://github.com/rifsxd/KernelSU-Next", "https://github.com/rifsxd/KernelSU-Next/releases/latest", "Advanced Root", listOf("Root", "Kernel", "System")),
        ShizukuApp("APatch", "Next-gen hybrid root solution for Android 16 — hooks kernel memory, supports APM and KPM modules.", "bmax121", "https://github.com/bmax121/APatch", "https://github.com/bmax121/APatch/releases/latest", "Advanced Root", listOf("Root", "Kernel", "System")),
