...
object ShizukuRepoParser {
    ...
    private fun getFallbackList(): List<ShizukuApp> {
        return listOf(
            ShizukuApp("LSPatch", "No-root Xposed framework. Patches APKs to inject modules without root — works with just Shizuku.", "LSPosed", "https://github.com/LSPosed/LSPatch", "https://github.com/LSPosed/LSPatch/releases/latest", "System Tools", listOf("LSPatch", "Shizuku")),
            ShizukuApp("LSPatch (JingMatrix)", "Actively maintained LSPatch fork with Android 14/15/16 support. Drop-in replacement for the original.", "JingMatrix", "https://github.com/JingMatrix/LSPatch", "https://github.com/JingMatrix/LSPatch/releases/latest", "System Tools", listOf("LSPatch", "Shizuku")),
            ShizukuApp("Vector (LSPosed fork)", "JingMatrix's actively maintained LSPosed fork for Android 16. Requires root + Magisk + Zygisk. Kotlin rewrite in progress.", "JingMatrix", "https://github.com/JingMatrix/LSPosed", "https://github.com/JingMatrix/LSPosed/releases/latest", "System Tools", listOf("Vector", "Root", "Dev")),
